# copied from https://devopslog.wordpress.com/2012/04/15/mergesort-example-using-python-multiprocessing/
# code by George P Sarakis
...
if __name__ == "__main__":
    ...
    print("Random list generated in %4.6f" % main_timer["list_generation"])
